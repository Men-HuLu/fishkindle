...
const env = 'Debug';
const base = env === 'Debug' ? 'http://192.168.1.97:5500/login/wxcustom' : 'http://192.168.1.97:5500/login/wxcustom';
...
const loginGet = (code) => wxHelper.request(url.login, 'get');
